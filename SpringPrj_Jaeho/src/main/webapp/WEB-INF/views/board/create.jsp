...
<body>
			<article>
					<div class="container" role="main">
						<h1>게시글 작성</h1>
			 				...
			 				<input type="text" id="b_title"  class="form-control"  name="b_title" placeholder="제목을 입력해주세요">
							</div>
		     <div class="mb-3">
	   ...
	   <div class="mb-3">
		<label for="reg_id">	작성자</label>
		 <input type="text" name="b_writer" id="b_writer" placeholder="작성자" value="${userId}" readonly>
		</div>
		<div>
