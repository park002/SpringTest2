                ...
                <div class="container clearfix">
                    ...
                    <nav id="primary-menu">
                        ...
                        <ul class="">
                            ...
                            <li><<a href="#" onclick="return false;"><div>다이닝</div></a>
                                <ul>
                                    <li><a href="dining-1.html"><div>파노라마 (올 데이 다이닝)</div></a></li>
                                </ul>
                            </li>
                            <li><a href="menu-item.jsp"><div>부대시설</div></a>
                                <ul>
...
<br>
<form>
<%-- <table style="margin-left: auto; margin-right: auto; font-size:18px;" width="1300" border="1">  
  <tr height="50">
    <td align="left" width="70" >${article.notice_title}</td>
    <td align="right" width="30"><fmt:formatDate value="${article.notice_date}" timeStyle="medium" pattern="yyyy-MM-dd" /></td>    
  </tr>
  </table> --%>
  ...
  <br>
  		<hr width="90%">
			<div style="width:1000px; height:30px; float: left; margin-left:100px; margin-top:-5px; margin-bottom:10px; font-size:20px; font-weight:bold">${article.notice_title}</div>
			<div style="width:200px; height:30px; float: right; margin-top:-5px; margin-bottom:10px; font-size:20px;">
				<fmt:formatDate value="${article.notice_date}" timeStyle="medium" pattern="yyyy-MM-dd" />
			</div>
		<hr width="90%">
  
	<div style="margin-left: auto; margin-right:auto; text-align:center;">
  	<textarea readonly="readonly" cols="100" rows="20" style="border: none; resize:none; margin-left: auto; margin-right:auto; text-align:center;">${article.notice_contents}</textarea> 
  	</div>
  	<hr width="90%">
<%--    <pre style="background-color:white; font-size:17px;">${article.notice_contents}</pre> --%>
   

	<div style="margin-left: auto; margin-right:auto; text-align:center;">
	<c:if test="${customer_id eq 'admin'}"> 
			  <input type="button" value="글수정" 
			  			 style="border:1px solid mediumblue; font-size:13pt; background-color:white; color:mediumblue; border-radius:5px;"
			  			  onclick="document.location.href='/hotel/updateForm.do?num=${article.notice_number}&pageNum=${pageNum}'">
			   &nbsp;&nbsp;&nbsp;&nbsp;
			  <input type="button" value="글삭제" 
			  			  style="border:1px solid mediumblue; font-size:13pt; background-color:white; color:mediumblue; border-radius:5px;"
			  			  onclick="document.location.href='/hotel/deleteForm.do?num=${article.notice_number}&pageNum=${pageNum}'">
			   &nbsp;&nbsp;&nbsp;&nbsp;
	</c:if>
		       <input type="button" value="목록보기" 
		       			   style="border:1px solid mediumblue; font-size:13pt; background-color:white; color:mediumblue; border-radius:5px;" 
		       			   onclick="document.location.href='/hotel/list.do?pageNum=${pageNum}'">
	</div>
</form> 
		...
		<!--                         <div class="heading-block center nobottommargin nobottomborder">
                            ...
                            <span>Instagram feed. Simply enter your Instagram user ID.</span>                        </div>                                    
                                    <div class="instagram-photos masonry-thumbs col-6 bottommargin-sm topmargin-sm" data-user="fatandfuriousburger" data-count="18" data-type="user"></div>

<pre>
data-user="fatandfuriousburger" data-count="18" data-type="user"
</pre>
                                ...
                                <div class="col_half nobottommargin">
                                    ...
                                    <div class="mpost clearfix">
                                        <div class="entry-image">
                                            <a href="#"><img src="http://placehold.it/400x300" alt="Blog Single"></a>                                        </div>
                                        <div class="entry-c">
