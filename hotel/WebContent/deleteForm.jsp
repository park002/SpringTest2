...
<br>
<center>
	<h5 style="color:red;">삭제후에는 게시물 복구가 불가합니다.</h5>
 <form method="POST" name="delForm" action="/hotel/deletePro.do?pageNum=${pageNum}&num=${num}" onsubmit="deleteSave()"> 
 <input type="submit" id="delcheck" value="삭제" style="border:1px solid red; font-size:12pt; background-color:white; color:red; border-radius:5px;">
      <input type="button" value="이전" style="border:1px solid red; font-size:12pt; background-color:white; color:red; border-radius:5px;" onclick="history.go(-1);">
</form>
</center>
