...
<style>
	...
	.input{
			border-color:cadetblue; border-right:0px; border-top:0px; border-left:0px; font-size:20px;
	}
	.input1{
			border-color:cadetblue; font-size:17px;
	}
</style>
...
<script type="text/javascript">
	...
	function chWrite() {
		if (document.wfmodity.subject.value == "") {
			alert("제목을 입력하세요.");
			document.wfmodity.subject.focus();
			return false;
		}
		if (document.wfmodity.content.value == "") {
			alert("내용을 입력하세요.");
			document.wfmodity.content.focus();
			return false;
		}
	}
</script>
...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        ============================================= -->
<br>
		<form method="post" name="wfmodity" action="/hotel/updatePro.do?pageNum=${pageNum}" onsubmit="return chWrite()">
			<table width="400" border="1" cellspacing="0" cellpadding="0" align="center">

				<div style="text-align: center">
					<input type="text" size="50" class="input" maxlength="100" id="subject" name="notice_title" value=" ${article.notice_title}">
				</div>
				<br>
				...
				<div style="text-align: center">
					<textarea id="content" class="input1" name="notice_contents" rows="20" cols="150">${article.notice_contents}</textarea>
				</div>
				...
				<center>
					<input type="submit" value="수정완료" style="border:1px solid darkcyan; font-size:13pt; background-color:white; color:darkcyan; border-radius:5px;">
					<input type="reset" value="다시작성" style="border:1px solid darkcyan; font-size:13pt; background-color:white; color:darkcyan; border-radius:5px;">
					<input type="button" value="목록보기" style="border:1px solid darkcyan; font-size:13pt; background-color:white; color:darkcyan; border-radius:5px;" onclick="document.location.href='/hotel/list.do?pageNum=${pageNum}'">
				</center>
