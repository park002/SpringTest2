...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <header id="header" class="full-header">
            ...
            <div id="header-wrap">
                ...
                <div class="container clearfix">
                    ...
                    ============================================= -->
                    <div id="logo">
                        <a href="index.do" class="standard-logo" data-dark-logo="images/logo/logo-dark.png"><img src="images/logo/footer-logo-large.png" alt="Chocolat Logo"></a>
                        <a href="index.do" class="retina-logo" data-dark-logo="images/logo/logo-dark-large.png"><img src="images/logo/footer-logo-large.png" alt="Chocolat Logo"></a>                   
                    </div><!-- #logo end -->
        ...
        ============================================= -->
       <section id="page-title" class="page-title-parallax" style="background-image: url('images/hotel-about/main.jpg'); padding: 120px 0;" data-stellar-background-ratio="0.3">
                ...
                <div id="contact-form-overlay" class="clearfix bgcolor-grey">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="well well-sm">${room_type }</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="well well-sm">${customer_id }</div>
						</div>
					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="well well-sm">${adult}</div>
						</div>

						<div class="col-md-6">
							<label for="template-contactform-name">어린이</label><br>
							<div class="well well-sm">${child }</div>
						</div>
					</div>
					...
					<div class="col_full">
                        ...
                        <div class="clearfix" style=" text-align:center;" >
                                ...
                                <button type="button" onclick="popup();" value="${reservation_number}" class="button button-medium button-reveal button-3d button-rounded tright nomargin" style="color:black; ">
