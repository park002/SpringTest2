...
<style>
	...
	function chWrite(){
		...
		if(document.wf.subject.value== ""){
			  alert("제목을 입력하세요.");
			  document.wf.subject.focus();
			  return false;
			}
			if(document.wf.content.value== ""){
			  alert("내용을 입력하세요.");
			  document.wf.content.focus();
			  return false;
			}
	}    
...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        ============================================= -->
<br>
	<form method="post" name="wf" action="/hotel/writePro.do" onsubmit="return chWrite()">
		...
		<input type="hidden" name="re_level" value="${re_level}">
			...
			<div style="text-align: center">
				<input type="text" class="input" size="50" maxlength="100" id="subject" name="notice_title" placeholder="제목을 입력하세요.">
			</div><br>

			<div style="text-align: center">
				<textarea id="content" class="input1"name="notice_contents" rows="20" cols="150" placeholder="내용을 입력하세요."></textarea>
			</div>

			<center>
			<input type="submit" value="글쓰기" style="border:1px solid darkcyan; font-size:13pt; background-color:white; color:darkcyan; border-radius:5px;">
			...
			<input type="button" value="목록보기" style="border:1px solid darkcyan; font-size:13pt; background-color:white; color:darkcyan; border-radius:5px;" onclick="window.location='/hotel/list.do'"> 
</center><br>
		</table>
</form>
