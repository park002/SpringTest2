...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax"
         style="background-image: url('./images/favicon/on2.jpg'); 
        ...
        <section id="content">
            ...
            <div class="content-wrap bgcolor-grey-light">
                ...
                <div class="container clearfix">
                    ...
                    <!--menu-item.jpg  -->
                        <img src="./images/favicon/on.jpg" alt="" width="300" height="430">                     
...
<b>※ </b>귀중품은 객실에 보관해 주시기 바랍니다.<br>
                    ...
                    <div id="related-portfolio" class="owl-carousel portfolio-carousel">
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/on.jpg" alt=""></a>
                                	<div class="portfolio-overlay">
                                    	<a href="./images/favicon/on.jpg" class="left-icon" data-lightbox="image">
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/on2.jpg" alt=""></a>
                                    <div class="portfolio-overlay">
                                    	<a href="./images/favicon/on2.jpg" class="left-icon" data-lightbox="image"><i class="icon-picture"></i></a>
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/on3.jpg" alt=""></a>
                                    <div class="portfolio-overlay">
                                        <a href="./images/favicon/on3.jpg" class="left-icon" data-lightbox="image"><i class="icon-picture"></i></a>
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/on5.jpg" alt=""></a>
                                    <div class="portfolio-overlay">
                                        <a href="./images/favicon/on5.jpg" class="left-icon" data-lightbox="image"><i class="icon-picture"></i></a>
