...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax"
         style="background-image: url('./images/favicon/ba.jpg'); 
        ...
        <section id="content">
            ...
            <div class="content-wrap bgcolor-grey-light">
                ...
                <div class="container clearfix">
                    ...
                    <!--menu-item.jpg  -->
                        <img src="./images/favicon/ba2.jpg" alt="" width="300" height="430">                     
...
<b>TEL +82-1234-1234 </b><br>
                    ...
                    <div id="related-portfolio" class="owl-carousel portfolio-carousel">
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/ba.jpg" alt=""></a>
                                	<div class="portfolio-overlay">
                                    	<a href="./images/favicon/ba.jpg" class="left-icon" data-lightbox="image">
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/ba2.jpg" alt=""></a>
                                    <div class="portfolio-overlay">
                                    	<a href="./images/favicon/ba2.jpg" class="left-icon" data-lightbox="image"><i class="icon-picture"></i></a>
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/ba3.jpg" alt=""></a>
                                    <div class="portfolio-overlay">
                                        <a href="./images/favicon/ba3.jpg" class="left-icon" data-lightbox="image"><i class="icon-picture"></i></a>
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/ba6.jpg" alt=""></a>
                                    <div class="portfolio-overlay">
                                        <a href="./images/favicon/ba6.jpg" class="left-icon" data-lightbox="image"><i class="icon-picture"></i></a>
                        ...
                        <div class="oc-item">
                            <div class="iportfolio">
                                <div class="portfolio-image">
                                    <a href="portfolio-single.html"><img src="./images/favicon/ba5.jpg" alt=""></a>
                                    <div class="portfolio-overlay">
                                        <a href="./images/favicon/ba5.jpg" class="left-icon" data-lightbox="image"><i class="icon-picture"></i></a>
