...
<body>
	...
	<form method="post" action="MemberAddForm2.jsp" onsubmit="return CheckForm(this)" name="agreeform">
		<h1>Hotel Delluna</h1>
		<div class="tabs"></div>
		<br> <input type="checkbox" name='check1' id='check1'> <label
			id="termsServiceLb" for="termsService"> 호텔 델루나 리워즈 회원 약관<span
			class="terms_choice">(필수)</span></label>
		<div class="terms_box">
			<div class="article">
				<h3 class="article__title">제 1 조 (목적)</h3>
				<p class="article__text">이 약관은 호텔 델루나가
					 제공하는 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타
			...
			<div class="article">
				...
				<ol class="sections">
					<li class="sections__section">①"서비스"라 함은 구현되는 단말기(PC, TV,
						휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는  서비스를
						의미합니다.</li>
